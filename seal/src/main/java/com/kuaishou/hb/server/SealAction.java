...
import com.kuaishou.hb.server.request.AddGroupMemberRequest;
import com.kuaishou.hb.server.request.AddToBlackListRequest;
import com.kuaishou.hb.server.request.AgreeFriendsRequest;
import com.kuaishou.hb.server.request.BaseTokenRequest;
import com.kuaishou.hb.server.request.ChangePasswordRequest;
import com.kuaishou.hb.server.request.CheckPhoneRequest;
import com.kuaishou.hb.server.request.CreateGroupRequest;
import com.kuaishou.hb.server.request.DeleteFriendRequest;
import com.kuaishou.hb.server.request.DismissGroupRequest;
import com.kuaishou.hb.server.request.FriendInvitationRequest;
import com.kuaishou.hb.server.request.GetGroupMemberRequest;
import com.kuaishou.hb.server.request.GetUserInfosRequest;
import com.kuaishou.hb.server.request.GroupMemberRequest;
import com.kuaishou.hb.server.request.JoinGroupRequest;
import com.kuaishou.hb.server.request.LoginRequest;
import com.kuaishou.hb.server.request.RegisterRequest;
import com.kuaishou.hb.server.request.RemoveFromBlacklistRequest;
import com.kuaishou.hb.server.request.RestPasswordRequest;
import com.kuaishou.hb.server.request.SearchFriendRequest;
import com.kuaishou.hb.server.request.SendCodeRequest;
import com.kuaishou.hb.server.request.SetFriendDisplayNameRequest;
import com.kuaishou.hb.server.request.SetGroupDisplayNameRequest;
import com.kuaishou.hb.server.request.SetGroupNameRequest;
import com.kuaishou.hb.server.request.SetGroupPortraitRequest;
import com.kuaishou.hb.server.request.SetNameRequest;
import com.kuaishou.hb.server.request.SetPortraitRequest;
import com.kuaishou.hb.server.request.SetSexRequest;
import com.kuaishou.hb.server.request.SetWhatupRequest;
import com.kuaishou.hb.server.request.VerifyCodeRequest;
import com.kuaishou.hb.server.response.AddGroupMemberResponse;
import com.kuaishou.hb.server.response.AddToBlackListResponse;
...
import com.kuaishou.hb.server.response.DismissGroupResponse;
...
import com.kuaishou.hb.server.response.GetShareRewardResponse;
...
import com.kuaishou.hb.server.response.OpenRedPacketResponse;
import com.kuaishou.hb.server.response.QiNiuTokenResponse;
import com.kuaishou.hb.server.response.QuitGroupResponse;
import com.kuaishou.hb.server.response.RedPacketReceiveResponse;
import com.kuaishou.hb.server.response.RedPacketSendResponse;
import com.kuaishou.hb.server.response.RegisterResponse;
import com.kuaishou.hb.server.response.RemoveFromBlackListResponse;
...
import com.kuaishou.hb.server.response.SetGroupNameResponse;
import com.kuaishou.hb.server.response.SetGroupPortraitResponse;
import com.kuaishou.hb.server.response.SetNameResponse;
import com.kuaishou.hb.server.response.SetPortraitResponse;
import com.kuaishou.hb.server.response.ShareLinkResponse;
import com.kuaishou.hb.server.response.SyncTotalDataResponse;
...
import com.kuaishou.hb.server.response.VersionResponse;
import com.kuaishou.hb.server.response.VideoLimitResponse;
import com.kuaishou.hb.server.response.VideoListResponse;
import com.kuaishou.hb.server.response.VideoUploadResponse;
import com.kuaishou.hb.server.utils.NLog;
import com.kuaishou.hb.server.utils.json.JsonMananger;
...
public class SealAction extends BaseAction {
    ...
    * */
	 ...
	 * @throws HttpException
	 */
	public VideoListResponse getVideoList() throws HttpException {
		String url = getURL("GetVideoList.aspx");
		...
		if (!TextUtils.isEmpty(result)) {
			response = jsonToBean(result, VideoListResponse.class);
		}
		return response;
	}
