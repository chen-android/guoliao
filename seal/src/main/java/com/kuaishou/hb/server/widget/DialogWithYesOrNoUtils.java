package com.kuaishou.hb.server.widget;
...
public class DialogWithYesOrNoUtils {
	...
	public void showEditDialog(Context context, String hintText, String OKText, int inputType, final DialogCallBack callBack) {
		final EditText et_search;
		AlertDialog.Builder dialog = new AlertDialog.Builder(context);
		LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		LinearLayout layout = (LinearLayout) inflater.inflate(R.layout.dialog_view, null);
	...
	public void showUpdatePasswordDialog(final Context context, final DialogCallBack callBack) {
		...
		dialog.setPositiveButton(R.string.confirm, new DialogInterface.OnClickListener() {
			public void onClick(DialogInterface dialog, int which) {
				...
				String cachePassword = context.getSharedPreferences("config", Context.MODE_PRIVATE).getString(GGConst.GUOGUO_LOGING_PASSWORD, "");
