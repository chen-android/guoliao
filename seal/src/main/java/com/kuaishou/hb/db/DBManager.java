...
public class DBManager {
	...
	private final static String DB_NAME = "GuoLiaoUserInfo";
	...
	private static String getDbPath() {
		String currentUserId = mContext.getSharedPreferences("config", MODE_PRIVATE).getString(GGConst.GUOGUO_LOGIN_ID, null);
