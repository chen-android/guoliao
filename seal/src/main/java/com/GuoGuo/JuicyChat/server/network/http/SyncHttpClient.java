package com.GuoGuo.JuicyChat.server.network.http;
...
public class SyncHttpClient {
	...
	public SyncHttpClient(SchemeRegistry schemeRegistry) {
		...
		HttpProtocolParams.setUserAgent(httpParams, "SealTalk v" + GGConst.SEALTALKVERSION + " (Android; targetsdkversion " + Build.VERSION.SDK_INT + ";)");
