...
public class GGRedPacketNotifyMessage extends MessageContent {
	...
	public static GGRedPacketNotifyMessage obtain(String redpacketId, long tomemberid, long fromuserid, int type, long money, String content, int sort, int count, int state, String createtime) {
		return new GGRedPacketNotifyMessage(redpacketId, tomemberid, fromuserid, type, money, content, sort, count, state, createtime);
	}

	public GGRedPacketNotifyMessage(String redpacketId, long tomemberid, long fromuserid, int type, long money, String content, int sort, int count, int state, String createtime) {
