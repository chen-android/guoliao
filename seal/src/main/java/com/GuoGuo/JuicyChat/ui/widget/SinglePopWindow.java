...
public class SinglePopWindow extends PopupWindow {
	...
	public SinglePopWindow(final Activity context, final Friend friend, final RongIMClient.BlacklistStatus blacklistStatus) {
		...
		RelativeLayout deleteRl = (RelativeLayout) conentView.findViewById(R.id.blacklist_delete);
		...
		blacklistStatusRL.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				if (blacklistStatus == RongIMClient.BlacklistStatus.IN_BLACK_LIST) {
					RongIM.getInstance().removeFromBlacklist(friend.getFriendid(), new RongIMClient.OperationCallback() {
						@Override
					...
					PromptPopupDialog.newInstance(context, context.getString(R.string.join_the_blacklist),
						...
						public void onPositiveButtonClicked() {
							RongIM.getInstance().addToBlacklist(friend.getFriendid(), new RongIMClient.OperationCallback() {
								@Override
								public void onSuccess() {
		...
		deleteRl.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				PromptPopupDialog.newInstance(context, "删除好友",
						"确定删除此好友？").setPromptButtonClickedListener(new PromptPopupDialog.OnPromptButtonClickedListener() {
					@Override
					public void onPositiveButtonClicked() {
						asyncTaskManager.request(DELETE_FRIEND, new OnDataListener() {
							@Override
							public Object doInBackground(int requestCode, String parameter) throws HttpException {
								return new SealAction(context).deleteFriend(friend.getFriendid());
							}
							...
							public void onFailure(int requestCode, int state, Object result) {
								NToast.shortToast(context, "删除失败");
							}
						});
					}
				}).show();
	...
	public void setListener(OnDeleteFriendListener listener) {
		mListener = listener;
	}
